...
class _R_SignUpScreenState extends State<R_SignUpScreen> {
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      if (tname.text.isEmpty &&
                          temail.text.isEmpty && tcall.text.isEmpty && tdesignation.text.isEmpty && tsalary.text.isEmpty && choice.isEmpty && _image == null) {
                        Fluttertoast.showToast(
                          msg: "Provided All Details ",
  ...
  Future<void> insertdata(String name,
      String email,
      String phone,
      String designation,
      String salary,
